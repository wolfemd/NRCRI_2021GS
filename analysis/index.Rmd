...
-  **GEBVs for parent selection:** `GEBV_NRCRI_ModelA_2021April29.csv`
-  **GETGVs for variety advancement:** `GETGV_NRCRI_ModelADE_2021April29.csv`
-  **Tidy, long-form CSV of predictions, including PEVs:** `genomicPredictions_NRCRI_2021April29.csv`
